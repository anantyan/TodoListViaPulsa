...
import id.anantyan.todolistviapulsa.BuildConfig
...
object RemoteModule {
    ...
    @Singleton
    @Provides
    fun provideTodoService(retrofit: Retrofit): PersonJobsService {
        return retrofit.create(PersonJobsService::class.java)
    }
}